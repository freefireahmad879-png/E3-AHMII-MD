const {
  ...
  const ownerNumber = ['923229854711']
  ...
  console.log('E3-AHMII-MD connected to whatsapp ✅')
  ...
  ║         
  ||https://whatsapp.com/channel/0029Vb72ICa1Hsq24tOjJX0J      
  ╟─────────────────╢
  ║ ♻ 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐋𝐈𝐍𝐊          
  ║       https://Wa.me//+923229854711          
  ╠═════════════════╣
  ║      your name               
  ║ > © ᴘᴏᴡᴇʀᴇᴅ ʙʏ E3-AHMII-MD       
  ╚═════════════════╝
`;
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send("hey, E3-AHMII-MD started✅");
  });
